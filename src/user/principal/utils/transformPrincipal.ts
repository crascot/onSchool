...
export class TransformPrincipal {
  static transform(data: InputPrincipalType): UserType;
  static transform(data: InputPrincipalType[]): UserType[];
  static transform(data: InputPrincipalType | InputPrincipalType[]): UserType | UserType[] {
