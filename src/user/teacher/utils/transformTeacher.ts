...
export class TransformTeacher {
  ...
  static transform(data: InputTeacherType[]): UserType[];
  static transform(data: InputTeacherType | InputTeacherType[]): UserType | UserType[] {
    if (Array.isArray(data)) {
      return data.map(value => ({
        ...
        teacherDetails: {
          subject_specialization: value.teacher_details_subject_specialization,
      ...
      return {
        ...
        teacherDetails: {
          subject_specialization: data.teacher_details_subject_specialization,
